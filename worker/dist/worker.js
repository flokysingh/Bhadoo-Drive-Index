...
(function () {
  ...
  const HTML = `<!DOCTYPE html><html lang=en><head><meta charset=utf-8><meta http-equiv=X-UA-Compatible content="IE=edge"><meta name=viewport content="width=device-width,initial-scale=1"><title>${self.props.title}</title><link href="https://cdn.jsdelivr.net/gh/ParveenBhadooOfficial/BhadooDriveIndex/web/src/assets/favicon.ico" rel="icon" type="image/png"><link href="https://cdn.jsdelivr.net/gh/ParveenBhadooOfficial/BhadooDriveIndex/web/dist/css/app.min.css" rel=stylesheet><link href="https://cdn.jsdelivr.net/gh/ParveenBhadooOfficial/BhadooDriveIndex/web/src/search-bar-new.min.css"  rel=stylesheet><script src='https://cdn.jsdelivr.net/npm/jquery@3.2.1/dist/jquery.min.js' type='text/javascript'></script><script src='https://cdn.jsdelivr.net/gh/ParveenBhadooOfficial/BhadooDriveIndex/web/src/search.min.js' type='text/javascript'></script></head><body><script>window.props = { title: '${self.props.title}', default_root_id: '${self.props.default_root_id}', api: location.protocol + '//' + location.host, upload: ${self.props.upload} }<\/script><div id=app></div><script src="//cdn.jsdelivr.net/gh/ParveenBhadooOfficial/BhadooDriveIndex/web/dist/js/app.min.js"><\/script><div class="drive-index-footer" id="hhfooter"> <span class="drive-index-footer-close" onclick="document.getElementById('hhfooter').style.display='none';">X</span> <center> <div class='container'> <div> <input type='text' id='search' placeholder='Search After Complete Loading'></div></center></div></body></html>`; 
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_gdindex/resources/')) {
      ...
      const r = await fetch(`https://cdn.jsdelivr.net/gh/ParveenBhadooOfficial/BhadooDriveIndex/web/dist/${remain}`);
